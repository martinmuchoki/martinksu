...
STAMP="$(date +%F_%H-%M-%S)"
BACKUP_DIR="backups/intelligence_analytics_stage1/$STAMP"
...
echo "======================================================"
echo "MIP PRO Intelligence Analytics — Stage 1"
echo "======================================================"

if [[ -f services/intelligence_analytics.py ]]; then
    cp services/intelligence_analytics.py \
       "$BACKUP_DIR/intelligence_analytics.py"
fi

cat > services/intelligence_analytics.py <<'PY'
...
echo
echo "==> Compiling analytics service"
...
print()
print("CURRENT REGIME:", regimes.get("current"))
print()
print(
    "MOST RECOMMENDED:",
    recommendations.get(
...
print()
print("REPOSITORY HEALTH:", health)
print()
print("SUMMARY STATUS:", summary.get("status"))
print("SUMMARY VERSION:", summary.get("version"))
...
assert "average_total_seconds" in engine
assert "current" in regimes
assert "top_symbols" in recommendations
assert health.get("integrity") == "ok"
...
print()
print("INTELLIGENCE ANALYTICS SERVICE TEST: PASS")
PY

echo
echo "==> Creating Stage 1 report"

cat > reports/intelligence_analytics_stage1.txt <<EOF
MIP PRO Intelligence Analytics — Stage 1
...
- Committee recommendation statistics
- Repository health
...
git add \
    ...
    reports/intelligence_analytics_stage1.txt

if git diff --cached --quiet; then
    echo "No Git changes to commit."
else
    git commit -m \
        "add intelligence analytics service"
fi

echo
echo "======================================================"
echo "Intelligence Analytics Stage 1: COMPLETE"
echo "======================================================"
echo
echo "No Flask routes or templates were modified."
